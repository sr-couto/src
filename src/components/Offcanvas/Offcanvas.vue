<template>
  <div class="lg:hidden">
    ...
    />
    <button
      class="fixed text-lg justify-center items-center dark:bg-transparent opacity-80 hover:opacity-100 p-2 dark:text-gray-100 bg-white font-bold text-gray-900 right-0 z-[1000] flex top-1"
      @click="show = !show"
    >
      <span>Menú</span>
      <svg
